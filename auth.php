...
<body>
        ...
        <div class="card auth-card shadow rounded-4 p-4 p-md-5">
            ...
            <form id="signInForm" class="auth-form">
                ...
                <div class="mb-3">
                    <div class="position-relative">
                        <input type="password" id="signInPassword" class="form-control border-dark rounded-3 pe-5"
            ...
            <form id="signUpForm" class="auth-form d-none">
                ...
                <div class="mb-3">
                    ...
                    <div class="position-relative">
                        <input type="password" id="signUpPassword" class="form-control border-dark rounded-3 pe-5"
                            placeholder="Enter password">

                        <i class="bi bi-eye-slash password-toggle" data-target="signUpPassword"></i>
                    </div>
                ...
                <div class="form-check mb-4">
                    ...
                    <label class="form-check-label" for="termsCheck">
                        I accept the <a href="#" data-bs-toggle="modal" data-bs-target="#termsModal"
                            class="text-decoration-underline text-light">Terms & Conditions</a>
                    </label>
                </div>
            ...
            <div class="modal-content custom-modal"> <!-- Add custom-modal here -->
                ...
                <div class="modal-body">
                    ...
                    <ul>
                        ...
                        <li>Any activity under your account is your responsibility. Notify us immediately if you suspect
                            unauthorized use.</li>
                    </ul>

                    <h5>Service Use</h5>
                    <ul>
                        <li>The account is solely for personal or business use related to ordering catering services.
                        </li>
                    ...
                    <ul>
                        <li>All orders placed through the account are binding and must be paid according to the payment
                            terms.</li>
                    ...
                    <h5>Communication</h5>
                    <ul>
                        <li>By creating an account, you agree to receive emails, notifications, and updates regarding
                            your orders and promotions.</li>
                        <li>You can opt-out of promotional emails at any time.</li>
                    </ul>

                    <h5>Content and Conduct</h5>
                    <ul>
                        <li>You agree not to post or submit content that is offensive, illegal, or infringes on others’
                            rights.</li>
                        <li>We reserve the right to remove inappropriate content or suspend accounts violating these
                            rules.</li>
                    </ul>

                    <h5>Limitation of Liability</h5>
                    <ul>
                        <li>We are not responsible for any losses, damages, or injuries caused by using the platform or
                    ...
                    <h5>Termination</h5>
                    <ul>
                        <li>We may suspend or terminate your account for violation of these Terms & Conditions or
                            fraudulent activity.</li>
                    </ul>

                    <h5>Changes to Terms</h5>
                    <ul>
                        <li>We may update these Terms & Conditions at any time. Users will be notified of significant
                            changes, and continued use of the account constitutes acceptance of the updated terms.</li>
                    </ul>
                </div>
    ...
    if (!email) {
        showError("Please enter your email first."); // reminder that email is required
        return;
    }
