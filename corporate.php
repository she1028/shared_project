...
<head>
    ...
    <title>YMZM | Corporate Packages</title>
...
<script>
    ...
    function renderPackage(pkg) {
        ...
        <div class="container-fluid">
            <div class="row my-5 p-5 shadow-sm" style="background-color: #B3BBE9;">
                <div class="d-flex flex-column flex-lg-row align-items-center gap-4">
                    
                    <!-- Package Image -->
                    <div class="flex-fill h-100 text-center d-flex align-items-center justify-content-center">
                        <img src="${pkg.image}" alt="corporate" class="img-fluid package-img">
                    </div>
                    ...
                    <div class="flex-fill h-100 d-flex align-items-center">
                        <div>
                            ...
                            <p class="pt-1 package-description">
                                ...
                                <button class="btn btn-sm btn-primary-custom" style="background-color:#172783;" 
                            ...
                            <div class="d-flex justify-content-between align-items-center" style="font-size: 20px;">
                                ...
                                <a href="event_form.php" class="btn btn btn-primary-custom" style="background-color: #172783;">
                                    Book Now
                                </a>
                            </div>
    ...
    corporatePackages.forEach(pkg => renderPackage(pkg));
</script>
