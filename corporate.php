    ...
    <nav class="navbar navbar-expand-lg bg-light navbar-light fixed-top shadow-sm mt-3 rounded-4 mx-4">
        <div class="container-fluid ps-4 pe-4">
            <a class="navbar-brand" href="index.html">
                <img src="images/YMZM-logo.png" alt="Logo" width="40" height="auto">
            </a>
...
<script>
    ...
    function renderPackage(pkg) {
        ...
        <div class="container-fluid">
            <div class="row my-5 p-5 shadow-sm" style="background-color: ${pkg.backgroundColor || '#B3BBE9'};">
                <div class="d-flex flex-column flex-lg-row align-items-center gap-4">
                    
                    <!-- Package Image -->
                    <div class="flex-fill h-100 text-center d-flex align-items-center">
                        <img src="${pkg.image}" alt="corporate" class="img-fluid"
