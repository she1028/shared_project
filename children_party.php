...
<head>
    ...
    <title>YMZM | Children's Party Packages</title>
...
<script>
    ...
    function renderPackage(pkg) {
        ...
        childrenPartyPackages.forEach(pkg => renderPackage(pkg));
</script>
