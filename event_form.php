      ...
      const foodMenuData = [
        {
          ...
          items: [
            { id: 'app-canapes', label: 'Canapes', price: 45 },
            { id: 'app-shanghai', label: 'Lumpiang Shanghai', price: 55 },
            { id: 'app-onion', label: 'Onion Rings', price: 40 },
            { id: 'app-mushroom', label: 'Stuffed Mushrooms', price: 60 },
            { id: 'app-cheese', label: 'Cheese Sticks', price: 40 },
            { id: 'app-quiche', label: 'Mini Quiche', price: 60 },
            { id: 'app-siomai', label: 'Pork Siomai', price: 55 },
            { id: 'app-crackers', label: 'Cheese Crackers', price: 35 },
            { id: 'app-lumpia', label: 'Fresh Lumpia', price: 50 },
            { id: 'app-nachos', label: 'Nachos', price: 70 },
            { id: 'app-tempura', label: 'Shrimp Tempura', price: 80 },
            { id: 'app-fries', label: 'French Fries', price: 30 },
            { id: 'app-hotdog', label: 'Hotdog Sticks', price: 35 },
            { id: 'app-nuggets', label: 'Chicken Nuggets', price: 45 },
            { id: 'app-skewers', label: 'Skewers', price: 65 },
            { id: 'app-soup', label: 'Mushroom Soup', price: 50 }
          ]
        },
        {
          title: 'Main Courses',
          ...
          items: [
            { id: 'main-caldereta', label: 'Caldereta', price: 180 },
            { id: 'main-shrimp', label: 'Butter Shrimp', price: 220 },
            { id: 'main-wings', label: 'Chicken Wings', price: 160 },
            { id: 'main-mac', label: 'Mac and Cheese', price: 140 },
            { id: 'main-fish', label: 'Fish Fillet', price: 150 },
            { id: 'main-pizza', label: 'Cheese Pizza', price: 250 },
            { id: 'main-cordon', label: 'Cordon Bleu', price: 200 },
            { id: 'main-menudo', label: 'Menudo', price: 180 },
            { id: 'main-roast', label: 'Roast Chicken', price: 320 },
            { id: 'main-adobo', label: 'Chicken Adobo', price: 170 },
            { id: 'main-eggcrabs', label: 'Egg Crabs', price: 280 },
            { id: 'main-liempo', label: 'Pork Liempo', price: 220 },
            { id: 'main-bistek', label: 'Bistek', price: 190 },
            { id: 'main-afritada', label: 'Chicken Afritada', price: 170 },
            { id: 'main-lechon', label: 'Lechon Belly', price: 260 },
            { id: 'main-spaghetti', label: 'Spaghetti', price: 130 }
          ]
        },
        {
          title: 'Desserts',
          selectionNote: 'select 4',
          items: [
            { id: 'dessert-puto', label: 'Puto', price: 60 },
            { id: 'dessert-pandan', label: 'Buko Pandan', price: 80 },
            { id: 'dessert-salad', label: 'Buko Salad', price: 90 },
            { id: 'dessert-cake', label: 'Cake', price: 120 },
            { id: 'dessert-coffee', label: 'Coffee Jelly', price: 70 },
            { id: 'dessert-cookies', label: 'Cookies', price: 50 },
            { id: 'dessert-cupcakes', label: 'Cupcakes', price: 65 },
            { id: 'dessert-icecream', label: 'Ice Cream', price: 75 },
            { id: 'dessert-maja', label: 'Maja Blanca', price: 70 },
            { id: 'dessert-ube', label: 'Ube Halaya', price: 85 },
            { id: 'dessert-leche', label: 'Leche Flan', price: 90 }
          ]
        },
        {
          title: 'Beverages',
          selectionNote: 'select 2',
          items: [
            { id: 'bev-water', label: 'Water', price: 45 },
            { id: 'bev-orange', label: 'Orange Juice', price: 45 },
            { id: 'bev-coke', label: 'Coca cola', price: 45 },
            { id: 'bev-sprite', label: 'Sprite', price: 45 },
            { id: 'bev-cucumber', label: 'Cucumber Lemonade', price: 45 },
            { id: 'bev-lemonade', label: 'Lemonade', price: 45 },
            { id: 'bev-icedtea', label: 'Iced tea', price: 45 },
            { id: 'bev-pineapple', label: 'Pineapple Juice', price: 45 }
          ]
        }
      ];
