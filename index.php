...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content p-3">
                ...
                <div class="modal-body">
                    <form id="modalRatingForm" method="POST" action="submit_rating.php">
                        <div class="mb-3">
                        ...
                        <div class="mb-3 text-center">
                            <div class="rating-group d-flex justify-content-center gap-1">
                                <input class="rating-input" type="radio" name="rating" id="rating-1" value="1">
                                <label class="rating-label" for="rating-1"><i class="bi bi-star-fill"
                                        style="font-size:1.5rem;color:#ffd700"></i></label>
                                <input class="rating-input" type="radio" name="rating" id="rating-2" value="2">
                                <label class="rating-label" for="rating-2"><i class="bi bi-star-fill"
                                        style="font-size:1.5rem;color:#ffd700"></i></label>
                                <input class="rating-input" type="radio" name="rating" id="rating-3" value="3" checked>
                                <label class="rating-label" for="rating-3"><i class="bi bi-star-fill"
                                        style="font-size:1.5rem;color:#ffd700"></i></label>
                                <input class="rating-input" type="radio" name="rating" id="rating-4" value="4">
                                <label class="rating-label" for="rating-4"><i class="bi bi-star-fill"
                                        style="font-size:1.5rem;color:#ffd700"></i></label>
                                <input class="rating-input" type="radio" name="rating" id="rating-5" value="5">
                                <label class="rating-label" for="rating-5"><i class="bi bi-star-fill"
                                        style="font-size:1.5rem;color:#ffd700"></i></label>
                            </div>
                        </div>
                        <div class="mb-3">
                ...
                <div class="col-md-10 text-center text-dark">
                    ...
                    <div class="modal fade" id="contactModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content contact-modal p-0 d-flex">

                                <!-- Left Info Panel -->
                                <div class="contact-info d-flex flex-column justify-content-center text-white p-4"
                                    style="flex: 0 0 40%; background-color: #e3a04a;">
                                    <h5>Contact Us</h5>
                                    <p><i class="bi bi-geo-alt-fill me-2"></i>067, Bawi, Padre Garcia, Batangas</p>
                                    <p><i class="bi bi-envelope-fill me-2"></i>ymzmcateringservices@gmail.com</p>
                                    <p><i class="bi bi-telephone-fill me-2"></i>09086912265</p>
                                </div>

                                <!-- Right Form Panel -->
                                <div class="contact-form p-4" style="flex: 1; background-color: #fff;">
                                    <h5>Get in Touch</h5>
                                    <p class="text-muted mb-4">Feel free to email us!</p>
                                    ...
                                    <form id="contactForm">
                                        ...
                                        <div class="mb-3">
                                            <textarea name="notes" class="form-control" placeholder="Your Message"
                                                rows="4" style="resize: none;"></textarea>
                                        </div>
                                        <div id="formMessage" class="mb-3"></div>
                                        <div class="text-center">
                                            <button type="submit" class="btn rounded-pill px-5"
                                                style="background-color: #373128; border-color: #372e20; color: #efefef;">
                                                SEND
                                            </button>
                                        </div>
                                    </form>
    ...
    `;
        ...
        function populateImages() {
            for (let repeat = 0; repeat < 3; repeat++) {
                for (let i = 0; i < categories.length; i++) {
                    ...
                    imgDiv.innerHTML = `
                <img src="` + cat.thumb + `" alt="` + cat.category + `" class="foodImg"></a>
            `;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            msgDiv.classList.add('mt-2', 'text-success', 'text-center');
                ...
                fetch(form.action, {
                    ...
                    .then(data => {
                        if (data.trim() === 'success') {
                            ...
                            msgDiv.textContent = "Thank you for your rating!";
