        ...
        <div class="modal-content p-3" style="background-color: #ede3d4;">
            <div class="modal-body">
                <div class="row align-items-center justify-content-center">
                    <!-- Back button -->
                    <div class="my-2">
                        <span class="d-inline-flex align-items-center border bg-light rounded-5 px-2 py-1 btn-outline-darkg-2 back-action g-2" style="font-size: 12px;" data-bs-dismiss="modal">
                            <i class="material-icons">&#xe5c4;</i>
                            <span>back</span>
                        </span>
                    </div>
                    <div class="col-lg-5 col-12">
                        <img id="modalRentalImage" class="img-fluid pic">
                    </div>
                    <div class="col-lg-7 col-12 p-2 mt-2">
                        ...
                        <div class="row align-items-center mt-5">
                            ...
                            <!-- availabile colors -->
                            <div class="col-12 justify-content-end mt-2">
                                <span class="fs-6 mx-0 mt-2">Available In: </span>
                                <span id="modalRentalColors" class="d-inline-flex flex-wrap gap-2"></span>
                            </div>
                        </div>
